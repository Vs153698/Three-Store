  ...
  return (
    <div className='filepicker-container'>
      ...
      <div className='mt-4 flex flex-wrap gap-3'>
        <CustomButton type = "outline" title = "Logo" handleClick={()=>readFile("logo")} className = "text-xs"/>
        <CustomButton type = "filled" title = "Full" handleClick={()=>readFile("full")} className="text-xs"/>
      </div>
    </div>
  )
}
